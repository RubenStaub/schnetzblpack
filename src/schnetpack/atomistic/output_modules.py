...
class AtomwiseZBL(Atomwise):
    """
    Predicts atom-wise energy contributions (with ZBL correction) and accumulates global prediction.
    ...
    def forward(self, inputs):
        ...
        # collect results
        result = {self.property: y, 'zbl': zbl_corr}
